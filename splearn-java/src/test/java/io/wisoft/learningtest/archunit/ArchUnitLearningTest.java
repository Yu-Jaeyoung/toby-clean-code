package io.wisoft.learningtest.archunit;
...
@AnalyzeClasses(packages = "io.wisoft.learningtest.archunit")
public class ArchUnitLearningTest {
    ...
    /**
     * Application 클래스는 adapter 의 클래스에 의존하면 안된다.
     */
    @ArchTest
    ...
    /**
     * Domain 의 클래스는 domain, java 표준 라이브러리에만 의존 해야한다.
     */
    @ArchTest
